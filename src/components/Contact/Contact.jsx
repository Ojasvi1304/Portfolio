  ...
  return (
    <SectionWrapper id="contact" className="bg-teal/5 dark:bg-teal/8">
      <div className="text-center max-w-xl mx-auto">
        ...
        <p className="text-lg text-ink-muted dark:text-[#9A958D] leading-relaxed mb-10">
          TODO: Add a short, warm tagline — e.g. "Have an idea or just want to chat? My inbox is always open."
        </p>

        <Button href="mailto:TODO:your@email.com" className="px-8 py-3 text-base">
          Say Hello
        </Button>
